...
All rights reserved.
---------------------------------------------
Redistribution is unrecommended.
...
---------------------------------------------
Minor update & bugfix. Should not be used with anything but 
jv_bot01.pk3. For personal use only (do not distribute this pk3 along 
with your maps).